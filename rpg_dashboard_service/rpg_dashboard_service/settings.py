"""
Django settings for rpg_dashboard_service project.
...
SECRET_KEY = 'django-insecure-k7u_q^pf@&%$o0xs*y&aglz88r5_tztr=!00w9*t&kw+_uz(cf'
...
ROOT_URLCONF = 'rpg_dashboard_service.urls'
...
WSGI_APPLICATION = 'rpg_dashboard_service.wsgi.application'
